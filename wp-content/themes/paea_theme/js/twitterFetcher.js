    ...
    callback: function(data) {
      ...
      while(n < x) {
        ...
        if (parseLinks) {
          ...
          if (printTime) {
            if (permalinks) {
              op += '<h4 class="timePosted"><a href="' + permalinksURL[n] +
                 '">' + times[n].getAttribute('aria-label') + '</a></h4>';
            } else {
              op += '<h4 class="timePosted">' +
                  times[n].getAttribute('aria-label') + '</h4>';
            }
          }
        } else {
          if (tweets[n].innerText) {
            ...
            if (printTime) {
              op += '<h4 class="timePosted">' + times[n].innerText + '</h4>';
            }
            ...
            if (printTime) {
              op += '<h4 class="timePosted">' + times[n].textContent + '</h4>';
            }
          }
        }
